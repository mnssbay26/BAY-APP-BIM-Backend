...
const {getAccountCompanies} = require("../../libs/acc/account_admin/get.companies")
const {getProjectUsers} = require("../../libs/acc/account_admin/get.project.users")
const { getProjectById } = require('../../libs/acc/account_admin/get.project.id');
...
const GetProjectData = async (req, res) => {
    ...
    try {
        ...
        const projectCompanies = await getAccountCompanies(token, projectId);
